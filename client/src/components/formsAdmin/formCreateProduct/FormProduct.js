		...
		<>
			...
			>
				<Form.Item
					name="groupCreate"
					label='Группа товара'
					tooltip={`Группа появиться внизу экрана на синем фоне со значком информация i. Пожалуйста не забывайте добавлять группу для нового товара (либо новая, либо которая внизу экрана при создании группы.)`}
					rules={[{
						required: true,
				...
				<Form.Item
					...
					name="img"
					valuePropName='img'
					tooltip="Все картинки должны быть одного размера!"
					rules={[{
						required: true,
				...
				<Form.Item
					label="Описание"
					name='info'
					tooltip="Описание Вы добовляете сами в админке (добавить заголовок характеристик и добавить характеристику."
					rules={[
						{
							required: true,
						},
